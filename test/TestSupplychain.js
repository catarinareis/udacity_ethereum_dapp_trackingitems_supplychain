...
contract('SupplyChain', function (accounts) {
    ...
    const productPrice = web3.utils.toWei("1", "wei")
    var itemState = 0
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async () => {
       ...
       /* var event = supplyChain.Harvested()
        ...
        let tx = await supplyChain.harvestItem(upc, originFarmerID, originFarmName, originFarmInformation, originFarmLatitude, originFarmLongitude, productNotes, {from: ownerID})
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
        ...
        let tx = await supplyChain.processItem(upc, {from: ownerID})
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
        ...
        let tx = await supplyChain.packItem(upc, {from: ownerID})
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
        ...
        let tx = await supplyChain.sellItem(upc, productPrice, {from: ownerID})
